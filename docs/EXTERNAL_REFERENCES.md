...
Em caso de conflito entre uma referência externa e as
**decisões arquiteturais inegociáveis** de
[`SESSION_HANDOFF_ELECTRON.md`](SESSION_HANDOFF_ELECTRON.md) (seção 3),
as decisões do projeto prevalecem.
...
- **Quando consultar:** ao trabalhar no bus de eventos, no roteamento de
  mensagens entre agentes ou no protocolo de coordenação.
...
- **Não adotar automaticamente:** o transporte concreto e quaisquer
  ...
  decisão de que "GitHub não é intermediador de mensagens" permanece.
