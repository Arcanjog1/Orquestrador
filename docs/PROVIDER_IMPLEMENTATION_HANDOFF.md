...
1. instale por cima o
   [`desktop-dev-1650c9c`](https://github.com/Arcanjog1/Orquestrador/releases/tag/desktop-dev-1650c9c)
   — `AI-Orchestrator-Setup.exe`, publicado pela
   [run 105](https://github.com/Arcanjog1/Orquestrador/actions/runs/34200844341)
