...
const display=(value:unknown)=>value===null||value===undefined?'Não informado':typeof value==='object'?JSON.stringify(value,(_key,item)=>item===null?'Não informado':item):String(value);
